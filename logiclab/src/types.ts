export type ScreenType = 'dashboard' | 'truth-tables' | 'calculator' | 'formula-sheet' | 'examples' | 'settings' | 'support' | 'quiz' | 'explanatory-videos' | 'math-propositions' | 'authors-conclusions';
